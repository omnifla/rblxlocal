...
/*
    ...
    Format: ExpirationTime;Ticket;Signature
    ExpirationTime: in UTC, format: m/d/Y g:i:s A
    Ticket: base64 encoded ticket, format: UserId:PlaceId:JobId:ExpirationTime
...
$formatedScript = [
    ...
    "PingUrl" => "",
    "PingInterval" => 120,
    "UserName" => "ROBLOX", // TODO: fetch from ticket or .ROBLOSECURITY
    "UserId" => 1,
    "SuperSafeChat" => false, // should be set to true for under 13 accounts or unauthenticated users.
    "CharacterAppearance" => "http://{$site_properties['hostname']}/Asset/CharacterFetch.ashx?userId=1&placeId={$placeId}", // TODO: fetch from db
    "ClientTicket" => "",
    "GameId" => $jobId,
    "PlaceId" => (int)$placeId,
    "MeasurementId" => 0,
