...
<div style="margin-top: 10px;">
    <div ><h2>Terms Of Service</h2></div>
    <div>
        <p>
            ...
            this site, you and your parents agree to abide by the following terms and conditions:
        </p>
        <div style="padding:0 20px;">
           <div class="tos-section">
                1. You must be 13 or above to access RBLX.local
                <p>
                    This is a common rule on every Roblox Revival and if we catch you being underage we will terminate your account off from the website.
                </p>
           </div>
            <div class="tos-section">
                <p>
                    2. Most models, games and content on the message boards come straight from other
            ...
            <div class="tos-section">
                3. All user content and communications on the RBLX.local site&nbsp;may be&nbsp;filtered
                and monitored. RBLX.local does not pre-screen all submitted content, but RBLX.local and its 
                ...
                <p>
                    <ul>
                        ...
                        <li>requests for money by using your models, RBLX.local Points or any other RBLX.local property
                        ...
                        <li>other information that RBLX.local deems, in its sole discretion, to be inappropriate
                            for this site </li>
                    </ul>
                    <p>
                        <b>BEWARE:</b> If you do <b>any of the above</b> we may <b>terminate your account without prior notice.</b>
                    </p>
                    <p>&nbsp;</p>
                </p>
                <b>Copyright Notice</b><br />
                RBLX.local respects the intellectual property rights of others and we ask our users to do the same. 
                RBLX.local is a community made project made to revive the old days of ROBLOX.   
                All of RBLX.local's logos, characters, names, and all related indicia are trademarks of Roblox
                Corporation, We will take down this project if Roblox wants us to.
            </div>
            <div class="tos-section">
                <p>
                    4. If you cheat on RBLX.local games or use cheat programs, including non-RBLX.local software
                    or programs, to play the games we will terminate your account.
                </p>
            </div>
            <div class="tos-section">
                <p>
                    5. Remember, this is a free website and we reserve the right to prohibit the use
        ...
        <br />
        <center>
            <font color="red" size="3">Remember - No member of RBLX.local staff will EVER ask you for
                your password!</font></center>
        <center>
            <font color="red" size="3">If you feel like you wanna provide feedback about the website and the development of this project, visit the RBLX.local Github page.</font></center>
    </div>
</div>
