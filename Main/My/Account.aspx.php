        ...
        <div id="BodyWrapper">
          <div id="RepositionBody">
            <div id="Body" style="width:970px">
              <div id="AccountPageContainer" data-missingparentemail="false" data-userabove13="true"
                data-currentdateyear="<?= date("Y") ?>" data-currentdatemonth="<?= date("n") ?>"
                data-currentdateday="<?= date("j") ?>">
                <div id="AccountPageLeft" class="divider-right">
                  ...
                  <form action="/My/Account/Update" id="UpdateAccountForm" method="post">
                    ...
                    <input name="__RequestVerificationToken" type="hidden"
                      value="Eyz0_gyuXxwx74Q6xigT8xOa7HTcrkFCdIXAsP3-5gCh1tvGtCpyPjgdVNGOAAdyxvlOpnrvwDNEiLM29Nn9DCIjp0EaLvoCixZwWQeHglUrLNswAzzeVOCNof8-qDSK-IPHJddxujB2d15i1oRWR55t4yg1">
                    <div class="tab-content active" id="settings_tab" style="display: block;">
                      <div id="AccountSettings" class="settings-section">
                        <div class="SettingSubTitle" id="UsernameSetting" <?php if ($user["robux"] < 1000) {
                          echo ('data-robux-remaining="' . (1000 - $user["robux"]) . '"');
                        } ?> data-email-verified="True"
                          data-alerturl="https://s3.amazonaws.com/images.roblox.com/cbb24e0c0f1fb97381a065bd1e056fcb.png"
                          data-change-username-verifyurl="/account/username/verifyupdate"
                          data-change-username-url="/account/username/update" data-buy-robux-url="/upgrades/robux">
                          <span class="settingLabel form-label">Username:</span> <span
                            id="username"><?= htmlspecialchars($user["username"]) ?></span>
                          <a class="btn-small btn-primary" id="changeUsername">Change My Username<span
                              class="btn-text">Change My Username</span></a>
                        </div>
                        <div id="BirthdaySetting" class="SettingSubTitle">
                          <span class="settingLabel form-label">Birthday:</span>
                          <div id="Over13Birthday">
                            <select class="accountPageChangeMonitor form-select" data-val="true"
                              data-val-number="The field BirthMonth must be a number."
                              data-val-range="The field BirthMonth must be between 1 and 12." data-val-range-max="12"
                              data-val-range-min="1" data-val-required="The BirthMonth field is required."
                              id="MonthDropDown" name="BirthMonth">
                              <?php
                            ...
                            <select class="accountPageChangeMonitor form-select" data-val="true"
                              data-val-number="The field BirthDay must be a number."
                              data-val-range="The field BirthDay must be between 1 and 31." data-val-range-max="31"
                              data-val-range-min="1" data-val-required="The BirthDay field is required."
                              id="DayDropDown" name="BirthDay">
                              <?php
                              for ($d = 1; $d <= 31; $d++) {
                            ...
                            <select class="accountPageChangeMonitor form-select" data-val="true"
                              data-val-number="The field BirthYear must be a number."
                              data-val-required="The BirthYear field is required." id="YearDropDown" name="BirthYear">
                              <?php
                              $currentYear = date("Y");
                              $startYear = $currentYear - 99;
                              $yearInRange = $year !== null && $year >= $startYear && $year <= $currentYear;
                              if (!$yearInRange) {
                        ...
                        <div id="GenderSetting" class="SettingSubTitle">
                          ...
                          <div id="GenderControl">
                            <?php
                            $genderRaw = (int) ($user['gender'] ?? 0);
                            $isMale = $genderRaw === 1;
                            $isFemale = $genderRaw === 2;
                            ?>
                            <div id="GenderSelectControl" class="accountPageChangeMonitor">
                              <label class="radio-selection">
                                <input <?= $isMale ? 'checked="checked"' : '' ?> data-val="true"
                                  data-val-required="The Gender field is required." id="Gender_2" name="Gender"
                                  type="radio" value="2">
                                <span for="Gender_2">Male</span>
                              </label>
                              <label class="radio-selection">
                                <input id="Gender_3" <?= $isFemale ? 'checked="checked"' : '' ?> name="Gender"
                                  type="radio" value="3">
                        ...
                        <div id="PasswordSetting" class="SettingSubTitle">
                          <span class="settingLabel form-label">Password:</span> <span
                            id="securePassword">*********</span>
                          <a id="changePassLink" class="changePassWord btn-control btn-control-small"
                            href="/Login/ChangePassword.aspx">
                            Change Password</a>
                        </div>
                        <div id="EmailAddressSetting" class="SettingSubTitle">
                          ...
                          <div id="emailBlock">
                            ...
                            <div id="NewsletterConfirm">
                              <input checked="checked" class="accountPageChangeMonitor" data-val="true"
                                data-val-required="The ReceiveNewsletter field is required." id="chkNewsletter"
                                name="ReceiveNewsletter" type="checkbox" value="true"
                                style="margin: 0px 3px 2px 0px; vertical-align: text-bottom;"><input
                                name="ReceiveNewsletter" type="hidden" value="false">
                              <span class="field-validation-valid" data-valmsg-for="ReceiveNewsletter"
                                data-valmsg-replace="true"></span>
                        ...
                        <div id="PersonalBlurbSetting" class="SettingSubTitle">
                          ...
                          <div id="BlurbDesc">
                            <textarea
                              class="roblox-blurb-default-text accountPageChangeMonitor text blurbGreyText valid"
                              cols="20" data-val="true"
                              data-val-length="The field Personal Blurb must be a string with a maximum length of 1000."
                              data-val-length-max="1000" id="blurbText" name="PersonalBlurb" rows="2"
                              title="Describe yourself here"><?= htmlspecialchars($user['description'] ?? "") ?></textarea>
                            <span class="field-validation-valid" data-valmsg-for="PersonalBlurb"
                              data-valmsg-replace="true"></span>
                            <br>
                        ...
                        <div id="LanguageTypeSettings" class="SettingSubTitle">
                          ...
                          <select class="accountPageChangeMonitor form-select valid" data-val="true"
                            data-val-number="The field LanguageId must be a number."
                            data-val-required="The LanguageId field is required." id="LanguageList" name="LanguageId">
                            <?php
                            ...
                            <option <?= ($selected_option == 2) ? 'selected="selected"' : '' ?> value="2">Português
                            </option>
                            ...
                            <option <?= ($selected_option == 9) ? 'selected="selected"' : '' ?> value="9">Nederlands
                            </option>
                            <option <?= ($selected_option == 10) ? 'selected="selected"' : '' ?> value="10">Русский
                            </option>
                          </select>
                          <span class="field-validation-valid" data-valmsg-for="LanguageId"
                            data-valmsg-replace="true"></span>
                        </div>
                        <div id="CountryTypeSettings" class="SettingSubTitle">
                          ...
                          <select class="accountPageChangeMonitor form-select valid" data-val="true"
                            ...
                            data-val-required="The CountryId field is required." id="CountryList" name="CountryId">
                          ...
                          <span class="field-validation-valid" data-valmsg-for="CountryId"
                            data-valmsg-replace="true"></span>
                        </div>
                        <div style="clear: both;">
                          <a class="btn-medium btn-neutral updateSettingsBtn" id="UpdateSettingsBtn1">Update<span
                              class="btn-text">Update</span></a>
                        </div>
                      </div>
                      <div id="AddEmailScreenModal" class="PurchaseModal simplemodal-data"
                        data-uid="<?= (int) $userId ?>"
                        ...
                        <div id="updateEmailBody">
                          <div id="AddEmailDialog">
                            ...
                            <div id="SubmitEmailButton">
                              <a id="SubmitInfoButton" class="btn-medium btn-neutral btn-disabled-neutral">Update<span
                                  class="btn-text">Update</span></a> <a id="CancelInfoButton"
                                class="btn-negative btn-medium">Cancel<span
                      ...
                      <div id="PrivacySettings" class="settings-section">
                        <div id="ChatSetting" class="SettingSubTitle">
                          ...
                          <span class="InlineSuperSafeDiv">
                            <select class="accountPageChangeMonitor form-select" id="ChatOptions"
                              name="ChatVisibilityPrivacy">
                            ...
                            <span class="field-validation-valid" data-valmsg-for="ChatVisibilityPrivacy"
                              data-valmsg-replace="true"></span>
                          </span>
                        </div>
                        <div id="PartySetting" class="SettingSubTitle">
                          ...
                          <span class="InlineSuperSafeDiv">
                            <select class="accountPageChangeMonitor form-select" id="PatryList"
                              name="PartyInvitePrivacy">
                              <option value="All">All Users</option>
                              <option value="TopFriends">Best Friends</option>
                              <option selected="selected" value="Friends">Friends</option>
                              <option value="Noone">No One</option>
                            ...
                            <span class="field-validation-valid" data-valmsg-for="PartyInvitePrivacy"
                              data-valmsg-replace="true"></span>
                          </span>
                        </div>
                        <div id="PrivateMessageSetting" class="SettingSubTitle">
                          ...
                          <span class="InlineSuperSafeDiv">
                            <select class="accountPageChangeMonitor form-select" id="MessageList"
                              name="PrivateMessagePrivacy">
                              <option value="All">All Users</option>
                              <option value="TopFriends">Best Friends</option>
                              <option selected="selected" value="Friends">Friends</option>
                              <option value="Noone">No One</option>
                            </select>
                            <span class="field-validation-valid" data-valmsg-for="PrivateMessagePrivacy"
                              data-valmsg-replace="true"></span>
                          </span>
                        </div>
                        <div id="FollowSetting" class="SettingSubTitle">
                          ...
                          <span class="InlineSuperSafeDiv">
                            <span id="SuperPanel" class="SuperSafePanel" data-js-supersafe-specialstyle="False"
                              style="left: 0px;">
                              <img class="SuperSafePrivacyModeImg"
                                src="https://s3.amazonaws.com/images.roblox.com/1e9979bd2ad8c88ee8d1250900ca6358.png"
                                alt="" style="">
                            </span>
                          </span>
                          <select class="accountPageChangeMonitor form-select" disabled="disabled" id="FollowList"
                            name="FollowMePrivacy" style="">
                          ...
                          <div
                            style="position: absolute; top: 0px; left: -5px; width: 2px; height: 23px; z-index: 1000; background-color: rgb(255, 255, 255); opacity: 0;">
                          </div>
                        </div>
                        <div style="clear: both;">
                          <a class="btn-medium btn-neutral updateSettingsBtn2"
                            id="UpdateSettingsBtn2">Update<span class="btn-text">Update</span></a>
                        </div>
                      </div>
                    </div>
                    <div class="tab-content" id="billing_tab">
                      <div id="MembershipSeting">
                        ...
                        <div class="SettingSubTitle billing-spacer">
                          For billing and payment questions: <span class="SL_swap" id="CsEmailLink"><a
                              href="mailto:info@roblox.com">info@roblox.com</a></span>
                        </div>
                      </div>
                    </div>
                  </form>
                ...
                <div id="AccountPageRight">
                  <div id="UpgradeAccount" style="margin-left: 10px">
                    ...
                    <div id="buyRobux" class="upgrade-account-button">
                      <a href="/upgrades/robux" class="btn-medium btn-primary">Buy Robux <span
                          class="btn-text">Buy Robux</span>
                      </a>
                    </div>
                    <div id="JoinBuildersClub" class="upgrade-account-button">
                      <a href="/Upgrades/BuildersClubMemberships.aspx" class="btn-medium btn-primary"> Join
                        Builders Club</a>
                    </div>
                    <div id="AdvertisementRight">
                      <div style="margin-top: 10px">
                        <iframe allowtransparency="true" frameborder="0" height="270" scrolling="no" src="/userads/3"
                          width="300" data-js-adtype="iframead"></iframe>
                      </div>
                    </div>
                  </div>
          ...
          <style type="text/css">
            ...
            /*Needs to be on the Page to override MasterPage #Body */
              {
              width: 970px;
              padding: 10px;
            }
