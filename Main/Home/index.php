...
<head>
    ...
    <script src="/js/GenericModal.js"></script>
    <script src="/js/GenericConfirmation.js"></script>
    <script src="/js/utilities/Cache.js"></script>
    <script src="/js/XsrfToken.js"></script>
    <script src="/js/JSErrorTracker.js"></script>
    <script src="/js/DeveloperConsoleWarning.js"></script>

    <link rel="stylesheet"
        href="https://<?= $site_properties['hostname'] ?>/CSS/Base/CSS/FetchCSS?path=leanbase___f9e2a82b042c4b4f945b16e30fb19e87_m.css">


    <link rel="stylesheet"
        href="https://<?= $site_properties['hostname'] ?>/CSS/Base/CSS/FetchCSS?path=page___0513ca5a00c9bdedff82380744b7def6_m.css">
    <link href="//fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,500,600,700" rel="stylesheet" type="text/css">

    <script async="" type="text/javascript" src="./<?= $site_properties['hostname'] ?>_files/gpt.js"></script>
    <script type="text/javascript" src="https://js.rbxcdn.com/9db05af88b1dc737664247f24a0120e0.js.gzip"></script>
    <link href="./<?= $site_properties['hostname'] ?>_files/BestFriends.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="https://js.rbxcdn.com/e96b59fba745a37cdd847ff394b79aac.js.gzip"></script>
    <script type="text/javascript" src="https://js.rbxcdn.com/9f4404fc11d8b8958d09f6316719cef9.js.gzip"></script>
    <script type="text/javascript" async="" src="./<?= $site_properties['hostname'] ?>_files/ga.js"></script>
    ...
    <script async="" type="text/javascript"
        src="./<?= $site_properties['hostname'] ?>_files/pubads_impl_30.js"></script>
    <script type="text/javascript" src="./<?= $site_properties['hostname'] ?>_files/osd.js"></script>
    <script type="text/javascript">Roblox.DeveloperConsoleWarning.showWarning()</script>
</head>
                ...
                <div class="nav-content-inner">
                    <div class="content">
                        <div id="HomeContainer" class="row home-container"
                            data-facebook-share="/facebook/share-character" data-update-status-url="/home/updatestatus"
                            ...
                            <div class="col-xs-12 home-header">
                                ...
                                <div class="home-header-content ">
                                    <h1><a
                                            href="/User.aspx"><?= $translated_contents[$user['language']]['hello'] . htmlspecialchars($user['username']) ?>!</a>
                                    </h1>
                                    <span
                                        class="rbx-icon-<?= $membershipNames[$user['membership_type']] ?? 'none' ?>"></span>
                                </div>
                            </div>
                            <div class="col-xs-12 section home-friends">
                                <div class="container-header">
                                    <h3><?= $translated_contents[$user['language']]['friends_label'] ?> (1)</h3>
                                    <a href="/friends.aspx#FriendsTab"
                                        class="rbx-btn-secondary-xs btn-more"><?= $translated_contents[$user['language']]['see_all'] ?></a>
                                </div>
                                ...
                                <ul class="hlist friend-list">
                                    <li class="list-item friend">
                                        <a href="/User.aspx?id=1" class="friend-link" title="TheGuyWhoIsIdiot">
                                            <span class="friend-avatar" data-3d-url="/avatar-thumbnail-3d/json?userId=1"
                                                data-js-files='https://js.rbxcdn.com/47e6e85800c4ed3c4eef848c077575a9.js.gzip'><img
                                                    alt='TheGuyWhoIsIdiot' class=''
                                                    src='/Thumbs/Avatar.ashx?userId=1&x=250&y=250' /></span>
                                ...
                                <ul class="hlist game-list">
                                    <li class="list-item game">
                                        <a href="/Place.aspx?placeId=1" class="game-item">
                                            <span class="game-thumb"><img class=""
                                                    src="//images.rbxcdn.com/04baeb33ef66ef1395cd5464309fece6.jpg"></span>
...
HTML;
                                ...
                                <div class="section">
                                    <div class="section-header">
                                        <h3>Blog News</h3>
                                        <a href="https://blog.<?= $site_properties['hostname'] ?>"
                                            class="rbx-btn-control-xs btn-more">See More</a>
                                    </div>
                                    ...
                                    <ul class="blog-news">
                                        <li class="news">
                                            ...
                                            <span class="news-link"><a
                                                    href="https://blog.<?= $site_properties['hostname'] ?>/2015/09/get-free-hats-win-prizes-in-the-endless-summer-camp-out/"
                                                    ref="news-article"
                                                    class="roblox-interstitial rbx-link rbx-article-title">Get Free Hats
                                                    &amp; Win Prizes in the Endless Summer Camp Out!</a></span>
                                        </li>
                                        <li class="news">
                                            <span class="rbx-icon-page"></span>
                                            <span class="news-link"><a
                                                    href="https://blog.<?= $site_properties['hostname'] ?>/2015/09/new-profile-pages-add-new-features-for-interacting-with-friends/"
                                                    ref="news-article"
                                                    class="roblox-interstitial rbx-link rbx-article-title">New Profile
                                                    Pages Add New Features for Interacting With Friends</a></span>
                                        </li>
                                ...
                                <div id="FacebookConnectCard" class="section">
                                    ...
                                    <center>
                                        ...
                                        <p style="width:70%;">Link your ROBLOX account with your Facebook account to let
                                            your Facebook friends see what you're doing on ROBLOX!</p>
                                    </center>
                                    <div id="connect-facebook">
                                        ...
                                        <div id="SocialIdentitiesInformation" data-rbx-login="/social/notify-login"
                                            ...
                                            data-rbx-login-redirect-url="/social/postlogin" data-user-is-authenticated>
                                        </div>
                                        <div class="connect-button" data-rbx-provider="facebook"
                                            style="background-image:url('https://cdns3.gigya.com/gs/GetSprite.ashx?path=%2FHTMLLogin%2FFullLogo%2F%5Bfacebook%5D_30.png%7C78%2C30');width:78px;height:30px;background-repeat:no-repeat">
                                        </div>
                                ...
                                <div class="section">
                                    ...
                                    <div class="rbx-form-horizontal" id="statusForm" role="form">
                                        <div class="rbx-form-group" id="groupYes">
                                            <input class="form-control rbx-input-field" id="txtStatusMessage"
                                                maxlength="254" placeholder="What are you up to?" />
                                            <p class="rbx-control-label">Status update failed.</p>
                                        </div>
                                        <a type="button" class="rbx-btn-primary-sm"
                                            id="shareButton"><?= $translated_contents[$user['language']]['share'] ?></a>
                                        <img id="loadingImage" class="share-login" style="display: none"
                                            alt="Sharing..."
                                            src="https://images.rbxcdn.com/ec4e85b0c4396cf753a06fade0a8d8af.gif"
                                            height="17" width="48" />
                                    </div>
                                    ...
                                    <ul class="vlist feeds">
                                        ...
                                        foreach ($feeds as $feed) {
                                            ...
                                            if ($author_id === null)
                                                continue;
                                            $author = Auth::GetUserInfo($author_id);
                                            if (!$author) {
                                                $author = ['username' => "[ Account Deleted $author_id ]", 'id' => $author_id];
                                            }
    ...
    HTML;
                        ...
                        <div id="Skyscraper-Adp-Right" class="abp abp-container right-abp">
                            ...
                            <iframe allowtransparency="true" frameborder="0" height="612" scrolling="no"
                                src="/userads/2" width="160" data-js-adtype="iframead"></iframe>
