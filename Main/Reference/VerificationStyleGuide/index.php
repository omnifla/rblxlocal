...
<body>
    <script type="text/javascript" src="/web/20140516222937js_/http://www.roblox.com/js/roblox.js"></script>
    <!-- Text Styles -->
    ...
    <div style="float:left;">
        <a class="StandardInTextLink">Standard Text in Link</a>
        <div class="tool_tip"><img src="/web/20140516222937im_/http://www.roblox.com/images/UI/img-tail-left.png" class="left">tool_tip left.<div>Multiline!</div>
            <div>Amazing!</div>
        </div>
        <a class="text-link">Standard Text in Link</a>
        <div class="tool-tip"><img src="/web/20140516222937im_/http://www.roblox.com/images/UI/img-tail-left.png" class="right">tool-tip left.<div>Multiline!</div>
            <div>Amazing!</div>
        </div>
        <a class="text-link">Standard Text in Link</a>
        <div class="tool-tip"><img src="/web/20140516222937im_/http://www.roblox.com/images/UI/img-tail-left.png" class="left">tool-tip left.<div>Multiline!</div>
            <div>Amazing!</div>
        </div>
        ...
        <div style="float:left;">
            <div class="dropdown">
                ...
                <ul class="dropdown-list" style="min-width: 135px; display: none;">
                    <li>
                        <a>Widgets Page</a>
                    </li>
                    <li>
