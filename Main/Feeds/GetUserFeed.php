...
$html = <<<HTML
                ...
                <a href="http://{$site_properties['hostname']}/user.aspx?id={$user['id']}"><span class="feed-user-avatar"><img alt="{$username}" class="feed-user-avatar-image" src="./ROBLOX.com_files/bed87dced341d944b093b1f9c9b148d7"></span>
