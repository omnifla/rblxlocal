<?php
// This is a resource file fetched from the ASP.NET Ajax framework.
// Some of the pages in this site uses ASP.NET ajax controls, and
// this file is required for those controls to work properly.
// However, as we are working on site, replacing all ASP.NET ajax
// for a proper system, this file will only be there for bringing life
// to the old controls, and will be removed in the future when we finish.
