...
<div id="forum-nav" style="text-align: right">
    ...
    <td align="center" valign="middle" style="width:25px;"><img title="Post (Not Read)" src="/images/Forums/thread-unread.png" style="border-width:0px;"></td>
    <td class="notranslate" style="height:25px;">
        <a class="post-list-subject" href="/Forum/ShowPost.aspx?PostID=<?= htmlspecialchars($thread['thread_id']) ?>">
    ...
    <td align="center" style="width:100px;white-space:nowrap;">
        <a class="last-post" href="http://forum.roblox.com/Forum/ShowPost.aspx?PostID=<?= htmlspecialchars($thread['thread_id']) ?>#last">
            ...
            <div class="normalTextSmaller notranslate"><?= htmlspecialchars($thread['last_poster_name']) ?></div>
        </a>
    </td>
</tr>
<?php endforeach; ?>
